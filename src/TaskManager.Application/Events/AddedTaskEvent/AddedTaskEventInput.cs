...
public class AddedTaskEventInput(Guid id, Guid projectId, Guid assignedUserId, string title, string description, DateTime endDate, string status, string priority) : IEventInput
{
