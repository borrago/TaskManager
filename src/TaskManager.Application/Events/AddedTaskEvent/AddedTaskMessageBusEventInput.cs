...
public class AddedTaskMessageBusEventInput(Guid id, Guid projectId, string title, string description, DateTime endDate, string status, string priority) : IMessageBusEventInput
{
